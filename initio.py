...
# IR Sensor Functions
#
# these boolean values are inversed because we need the iBoost64 to make the sensors work
# and the iBoost64 inverts the signals
#
# irLeft(): Returns state of Left IR Obstacle sensor
def irLeft():
    #these boolean values are inversed because we need the iBoost64 to make the ir sensors work
...
def setServo(Servo, Degrees):
    #print 'ServosActive ' + str(ServosActive)
    webiopi.debug('ServosActive:' + str(ServosActive))
